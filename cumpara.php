      ...
      <div id="content">
		...
		<form action="" method="post">
          <div class="form_settings">
            ...
            <p><span>CodProdus</span><input class="contact" type="text" name="your_email" value="" /></p>
            <p><span>Adresa</span><textarea class="contact textarea" rows="8" cols="50" name="your_enquiry"></textarea></p>
...
{ $nume=$_POST['your_name'];
  $codprodus=$_POST['your_email'];
  $Adresa=$_POST['your_enquiry'];
        
 $z=mysql_query("INSERT INTO BDobre.Cumpara (Nume,CodProdus,Adresa) 
 VALUES ('$nume','$codprodus', '$Adresa')",$x);
 if(!$z)
...
if(isset($_GET['action'])){
     ...
     if ($_GET['action']=="trimis") {
		echo '<script type="text/javascript">alert("Tranzactia a fost preluata!");</script>';
